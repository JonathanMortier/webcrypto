...
export default function Header({
  ...
  const isBourse = useLocation().pathname === '/bourse';

  return (
    <header className="header">
      <NavMenu />
      <h1>CryptoWatch</h1>
      {!isBourse && <p className="subtitle">Suivez les cours des principales cryptomonnaies en temps réel</p>}
        ...
        {!isBourse && (
          ...
          >
            <svg
              ...
              stroke={showFavoritesOnly ? '#ffd700' : 'currentColor'}
              strokeWidth="2"
            >
